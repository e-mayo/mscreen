...
python mscreen.py  screen -l ../data/ligands -r ../data/receptor -c ../data/config_vina_ex2.txt -o ../data/out-vina-screening-prepare -d vina -v -p 
echo SCREENING+PREPARE VINA OK

echo "##############################################"
echo TESTING SCREENING+PREPARE PLANTS
python mscreen.py screen  -l ../data/ligands -r ../data/receptor -c ../data/test_plants_speed1.txt -o ../data/out-plants-screening-prepare -v -d plants -p
echo"SCREENING+PREPARE PLANTS

echo "##############################################"
echo TESTING SCREENING+PREPARE AUTODOCK
python mscreen.py screen  -l ../data/ligands -r ../data/receptor -c ../data/test_autodock.txt -o ../data/out-autodock-screening-prepare -v -d autodock -p
echo PREPARING SCREENING+PREPARE AUTODOCK

echo "##############################################"
echo TESTING SCREENING+PREPARE AUTODOCKZN
python mscreen.py screen  -l ../data/ligands -r ../data/receptor -c ../data/test_autodockzn.txt -o ../data/out-autodockzn-screening-prepare -v -d autodockzn -p
